...
class GmshAdapter(Adapter):
    ...
    def generate(self, output_dir: Path) -> tuple[Path, ...]:
        ...
        lines = [
            ...
            "//   gmsh ehd_cell.geo -2 -o ehd_cell.msh",
            "//",
...
class ElmerAdapter(Adapter):
    ...
    def generate(self, output_dir: Path) -> tuple[Path, ...]:
        ...
        lines = [
            ...
            "!",
            "! Mesh: convert the Gmsh output (ehd_cell.geo -> ehd_cell.msh) with ElmerGrid",
            "! before running ElmerSolver, e.g.  ElmerGrid 14 2 ehd_cell.msh -autoclean",
            "! That conversion has not been performed or verified on this machine; 'Mesh DB'",
            "! below names the directory ElmerGrid would produce.",
            "!",
            ...
            "! force and no-slip walls everywhere this .sif solves to the trivial zero-velocity",
            "! field; it exists so the mesh and boundary wiring can be checked once Elmer is",
            "! installed, not to produce a flow result.",
            "!",
            ...
            '  Output File Name = File "ehd_cell"',
...
class ParaviewAdapter(Adapter):
    ...
    def generate(self, output_dir: Path) -> tuple[Path, ...]:
        ...
        lines = [
            ...
            "IMAGE_HEIGHT_PX = 600",
            "",
            'source = OpenDataFile("ehd_cell0001.vtu")',
            ...
            "Render()",
            'SaveScreenshot("ehd_cell_render.png", view,',
        ...
        path = output_dir / "ehd_cell_render.py"
        path.write_text("\n".join(lines), encoding="utf-8")
        return (path,)
